...
function Button({ children, disabled, to, type, onClick }) {
  ...
  const styles = {
    ...
    secondary: ` text-sm px-4 py-3 md:px-6 md:py-4
    inline-block rounded-full border-2 border-stone-300
    font-semibold uppercase tracking-wide focus:text-stone-800
    text-stone-400 transition-colors duration-300 
    hover:bg-stone-300 focus:bg-stone-300 hover:text-stone-800
